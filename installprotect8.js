        ...
        if ($user) {
            if ($user->id !== 1) {
                ...
                if ($ownerId === null) {
                    ...
                    throw new DisplayException('Akses ditolak: Lu siapa Longorr 😹 Buy akses ke @LexxPiero.');
                }

                if ($ownerId !== $user->id) {
                    throw new DisplayException('Akses ditolak: Anda hanya dapat menghapus server milik Anda sendiri @𝗣𝗥𝗢𝗧𝗘𝗖𝗧.');
                }
            }
